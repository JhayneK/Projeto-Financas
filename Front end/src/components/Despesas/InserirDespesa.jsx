            ...
            <div className="caixa-cadastro fadeInDown">
                <div className="caixa-cadastro-content">
                    <div className="caixa-cadastro-coluna">
                        ...
                        <label style={{marginTop: "1.5rem", fontWeight: "bold"}}>Valor</label>
                        <input
                            className={`${
                    ...
                    <div className="caixa-cadastro-coluna">
                        ...
                        <label style={{marginTop: "1.5rem", fontWeight: "bold"}}>Data</label>
                        ...
                        <label style={{marginTop: "1.5rem", fontWeight: "bold"}}>Descrição</label>
                        <textarea
                            className={`${
                                camposVazios.descricao ? "campo-vazio" : ""
                            }`}
                            style={{padding: "5px 5px", resize: "none", height: "5.2rem", width: "205%"}}
                            name="descricao"
                            id=""
                            value={descricao}
                    ...
                    <div className="caixa-cadastro-coluna">
                        ...
                        <label style={{marginTop: "1.5rem", fontWeight: "bold"}}>Parcelamento (x)</label>
                        <input
                            className={`${
                            ...
                            style={{height: "1.12rem", width: "99%", padding: "5px 5px"}}
                            type="text"
                            value={parcelamento}
