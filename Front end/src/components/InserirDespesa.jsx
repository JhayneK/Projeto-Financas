...
export default function InserirDespesa({ onClose }) {
  ...
  return !exibirCarregamento ? (
    <div className="tela-inserir">
      <div className="caixa-cadastro fadeInDown">
            ...
            <div className="caixa-cadastro-alinhamento">
              <div>
                ...
                >
                  <label>Valor</label>
                  <input
                    className={`${camposVazios.valor ? "campo-vazio" : ""}`}
                    type="text"
                    value={valor}
            ...
            <div className="caixa-cadastro-alinhamento">
              <div>
                <div className="caixa-cadastro-espacamento">
                  ...
                  <select
                    className={`${camposVazios.categoria ? "campo-vazio" : ""}`}
                    name="categora"
                    id=""
                    value={categoria}
                ...
                >
                  ...
                  <input
                    className={`${
                      camposVazios.parcelamento && parcelamentoHabilitado
                        ? "campo-vazio"
                        : ""
                    }`}
                    type="text"
            ...
            <div className="caixa-cadastro-alinhamento">
              <div>
                <div className="caixa-cadastro-espacamento">
                  ...
                  <select
                    className={`${
                      camposVazios.metodoPagamento ? "campo-vazio" : ""
                    }`}
                ...
                >
                  ...
                  <textarea
                    className={`${camposVazios.descricao ? "campo-vazio" : ""}`}
                    name="descricao"
                    id=""
                    value={descricao}
        ...
        <div className="botoes-cadastro">
          ...
          <button onClick={limparCampos} style={{ marginLeft: "0.5vw" }}>
            Limpar
          </button>
        </div>
      </div>
    ...
    <div className="tela-inserir">
      <div
        className={`caixa-cadastro fadeInDown ${
          exibirCarregamento ? "em-segundo-plano" : ""
        }`}
      >
        {exibirCarregamento && <TelaCarregamento />}{" "}
        {/* Exibe a tela de carregamento apenas na tela principal */}
      </div>
    </div>
  );
}
